...
class SrcAttribute extends WebViewAttribute {
  ...
  parse () {
    ...
    ipcRenderer.send('ELECTRON_BROWSER_ASYNC_CALL_TO_GUEST_VIEW', null, guestInstanceId, method, ...args)
  }
}
...
WebViewImpl.prototype.setupWebViewAttributes = function () {
  ...
  this.attributes[webViewConstants.ATTRIBUTE_DISABLEREMOTEMODULE] = new BooleanAttribute(webViewConstants.ATTRIBUTE_DISABLEREMOTEMODULE, this)
